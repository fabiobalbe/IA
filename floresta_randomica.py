...
# construindo floresta randomica
florestaRandomica = RandomForestClassifier(n_estimators=1000)  # numero de arvores

# treinar a floresta
florestaRandomica.fit(x_treino, y_treino)

# testar se floresta faz a predição corretamente
